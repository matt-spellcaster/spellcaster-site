...
export const site = {
  ...
  // The home page's meta description (search results, link previews). Not shown on the page.
  description:
    'Matthew Spell does full stack IT. Here are some things he built, with the code on GitHub.',
